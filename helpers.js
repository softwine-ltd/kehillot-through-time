...
const historicalArrows = [
    ...
    // Additional major expulsions from Wikipedia timeline
    {
        startLat: 48.2082,
        startLon: 16.3738,
        endLat: 52.0,
        ...
        yearStart: 1421,
        yearEnd: 1421,
        titleEn: "Expulsion from Austria (1421)",
        titleHe: "גירוש מאוסטריה (1421)",
        color: expulsion_color,
        description: "Duke Albert V ordered the expulsion of Jews from Austria, known as the Vienna Gesera"
    },
    {
        startLat: 41.9028,
        startLon: 12.4964,
        ...
        yearStart: 1569,
        yearEnd: 1569,
        titleEn: "Expulsion from Papal States (1569)",
        titleHe: "גירוש ממדינת האפיפיור (1569)",
        color: expulsion_color,
        description: "Pope Pius V expelled Jews from most of the Papal States, allowing them to reside only in Rome and Ancona"
    },
    {
        startLat: 54.6872,
        startLon: 25.2797,
        ...
        yearStart: 1495,
        yearEnd: 1503,
        titleEn: "Expulsion from Lithuania (1495-1503)",
        titleHe: "גירוש מליטא (1495-1503)",
        color: expulsion_color,
        description: "Grand Duke Alexander expelled Jews from Lithuania; they were allowed to return in 1503"
    },
    {
        startLat: 52.5200,
        startLon: 13.4050,
        ...
        yearStart: 1510,
        yearEnd: 1510,
        titleEn: "Expulsion from Brandenburg (1510)",
        titleHe: "גירוש מברנדנבורג (1510)",
        color: expulsion_color,
        description: "Following a blood libel accusation, Jews were expelled from Brandenburg"
    },
    {
        startLat: 50.0755,
        startLon: 14.4378,
        ...
        yearStart: 1745,
        yearEnd: 1748,
        titleEn: "Expulsion from Prague (1745-1748)",
        titleHe: "גירוש מפראג (1745-1748)",
        color: expulsion_color,
        description: "Empress Maria Theresa ordered the expulsion of Jews from Prague; they were permitted to return in 1748"
    },
    {
        startLat: 48.1351,
        startLon: 11.5820,
        ...
        yearStart: 1348,
        yearEnd: 1350,
        titleEn: "Black Death Expulsions (1348-1350)",
        titleHe: "גירושים במגפת המוות השחור (1348-1350)",
        color: expulsion_color,
        description: "During the Black Death, Jews were accused of poisoning wells and faced expulsions across German states"
    },
    {
        startLat: 52.2297,
        startLon: 21.0122,
        ...
        yearStart: 1483,
        yearEnd: 1800,
        titleEn: "Expulsion from Warsaw (1483-1800)",
        titleHe: "גירוש מוורשה (1483-1800)",
        color: expulsion_color,
        description: "Jews were expelled from Warsaw, Poland, and not allowed to return until the late 18th century"
    },
    {
        startLat: 40.8518,
        startLon: 14.2681,
        ...
        yearStart: 1541,
        yearEnd: 1541,
        titleEn: "Expulsion from Naples (1541)",
        titleHe: "גירוש מנאפולי (1541)",
        color: expulsion_color,
        description: "Under Spanish rule, Jews were expelled from the Kingdom of Naples"
    },
    {
        startLat: 48.1351,
        startLon: 11.5820,
        ...
        yearStart: 1442,
        yearEnd: 1442,
        titleEn: "Expulsion from Bavaria (1442)",
        titleHe: "גירוש מבוואריה (1442)",
        color: expulsion_color,
        description: "Duke Albrecht III expelled Jews from Upper Bavaria"
    },
    {
        startLat: 48.5734,
        startLon: 7.7521,
        ...
        yearStart: 1349,
        yearEnd: 1349,
        titleEn: "Expulsion from Strasbourg (1349)",
        titleHe: "גירוש משטרסבורג (1349)",
        color: expulsion_color,
        description: "Following the Black Death persecutions, Jews were expelled from Strasbourg"
    },
    {
        startLat: 50.0755,
        startLon: 8.2398,
        ...
        yearStart: 1438,
        yearEnd: 1438,
        titleEn: "Expulsion from Mainz (1438)",
        titleHe: "גירוש ממיינץ (1438)",
        color: expulsion_color,
        description: "Jews were expelled from Mainz, a major center of Jewish learning"
    },
    {
        startLat: 50.9375,
        startLon: 6.9603,
        ...
        yearStart: 1424,
        yearEnd: 1798,
        titleEn: "Expulsion from Cologne (1424-1798)",
        titleHe: "גירוש מקלן (1424-1798)",
        color: expulsion_color,
        description: "Jews were expelled from Cologne and not readmitted until 1798"
    },
    {
        startLat: 49.4521,
        startLon: 11.0767,
        ...
        yearStart: 1498,
        yearEnd: 1498,
        titleEn: "Expulsion from Nuremberg (1498)",
        titleHe: "גירוש מנירנברג (1498)",
        color: expulsion_color,
        description: "Jews were expelled from Nuremberg by an order of the Holy Roman Emperor Maximilian I"
    },
    {
        startLat: 49.0134,
        startLon: 12.1016,
        ...
        yearStart: 1519,
        yearEnd: 1519,
        titleEn: "Expulsion from Regensburg (1519)",
        titleHe: "גירוש מרגנסבורג (1519)",
        color: expulsion_color,
        description: "After the death of Emperor Maximilian I, Jews were expelled from Regensburg"
    },
    {
        startLat: 48.2082,
        startLon: 16.3738,
        ...
        yearStart: 1670,
        yearEnd: 1670,
        titleEn: "Expulsion from Vienna (1670)",
        titleHe: "גירוש מוינה (1670)",
        color: expulsion_color,
        description: "Emperor Leopold I ordered the expulsion of Jews from Vienna"
    },
    {
        startLat: 49.7437,
        startLon: 15.3386,
        ...
        yearStart: 1744,
        yearEnd: 1748,
        titleEn: "Expulsion from Bohemia and Moravia (1744-1748)",
        titleHe: "גירוש מבוהמיה ומוראביה (1744-1748)",
        color: expulsion_color,
        description: "Empress Maria Theresa ordered the expulsion of Jews from Bohemia and Moravia; the order was rescinded in 1748"
    },
    {
        startLat: 53.5511,
        startLon: 9.9937,
        ...
        yearStart: 1649,
        yearEnd: 1649,
        titleEn: "Expulsion from Hamburg (1649)",
        titleHe: "גירוש מהמבורג (1649)",
        color: expulsion_color,
        description: "Jews were expelled from Hamburg but were later readmitted"
    },
    {
        startLat: 53.8655,
        startLon: 10.6865,
        ...
        yearStart: 1816,
        yearEnd: 1850,
        titleEn: "Expulsion from Lübeck (1816-1850)",
        titleHe: "גירוש מליבק (1816-1850)",
        color: expulsion_color,
        description: "Jews were expelled from Lübeck and not allowed to return until the mid-19th century"
    },
    {
        startLat: 50.1109,
        startLon: 8.6821,
        ...
        yearStart: 1614,
        yearEnd: 1616,
        titleEn: "Expulsion from Frankfurt (1614-1616)",
        titleHe: "גירוש מפרנקפורט (1614-1616)",
        color: expulsion_color,
        description: "Vincent Fettmilch led a pogrom resulting in the expulsion of Jews from Frankfurt; they were readmitted two years later"
    },
    {
        startLat: 52.3676,
        startLon: 4.9041,
        ...
        yearStart: 1444,
        yearEnd: 1444,
        titleEn: "Expulsion from Netherlands (1444)",
        titleHe: "גירוש מהולנד (1444)",
        color: expulsion_color,
        description: "Jews were expelled from the Netherlands but were later allowed to return"
    },
    {
        startLat: 51.1079,
        startLon: 17.0385,
        ...
        yearStart: 1453,
        yearEnd: 1453,
        titleEn: "Expulsion from Breslau (1453)",
        titleHe: "גירוש מברסלאו (1453)",
        color: expulsion_color,
        description: "Jews were expelled from Breslau (now Wrocław, Poland)"
    },
    {
        startLat: 50.9787,
        startLon: 11.0328,
        ...
        yearStart: 1458,
        yearEnd: 1458,
        titleEn: "Expulsion from Erfurt (1458)",
        titleHe: "גירוש מארפורט (1458)",
        color: expulsion_color,
        description: "Jews were expelled from Erfurt, Germany"
    },
    {
        startLat: 49.7913,
        startLon: 9.9534,
        ...
        yearStart: 1560,
        yearEnd: 1560,
        titleEn: "Expulsion from Würzburg (1560)",
        titleHe: "גירוש מוירצבורג (1560)",
        color: expulsion_color,
        description: "Jews were expelled from Würzburg, Germany"
    },
    {
        startLat: 53.4285,
        startLon: 14.5528,
        ...
        yearStart: 1492,
        yearEnd: 1492,
        titleEn: "Expulsion from Pomerania (1492)",
        titleHe: "גירוש מפומרניה (1492)",
        color: expulsion_color,
        description: "Jews were expelled from the Duchy of Pomerania"
    },
    {
        startLat: 53.6288,
        startLon: 12.2471,
        ...
        yearStart: 1492,
        yearEnd: 1492,
        titleEn: "Expulsion from Mecklenburg (1492)",
        titleHe: "גירוש ממקלנבורג (1492)",
        color: expulsion_color,
        description: "Jews were expelled from Mecklenburg, Germany"
    },
    {
        startLat: 51.0504,
        startLon: 13.7373,
        ...
        yearStart: 1432,
        yearEnd: 1432,
        titleEn: "Expulsion from Saxony (1432)",
        titleHe: "גירוש מסקסוניה (1432)",
        color: expulsion_color,
        description: "Jews were expelled from Saxony, Germany"
    },
    {
        startLat: 50.2649,
        startLon: 19.0238,
        ...
        yearStart: 1582,
        yearEnd: 1582,
        titleEn: "Expulsion from Silesia (1582)",
        titleHe: "גירוש משלזיה (1582)",
        color: expulsion_color,
        description: "Jews were expelled from Silesia (now part of Poland and the Czech Republic)"
    },
    {
        startLat: 40.0,
        startLon: -3.0,
        ...
        yearStart: 1533,
        yearEnd: 1533,
        titleEn: "Expulsion from Kingdom of Naples (1533)",
        titleHe: "גירוש מממלכת נאפולי (1533)",
        color: expulsion_color,
        description: "Jews were expelled from the Kingdom of Naples under Spanish rule"
    },
    {
        startLat: 44.4056,
        startLon: 8.9463,
        ...
        yearStart: 1515,
        yearEnd: 1515,
        titleEn: "Expulsion from Genoa (1515)",
        titleHe: "גירוש מגנואה (1515)",
        color: expulsion_color,
        description: "Jews were expelled from Genoa, Italy"
    },
    {
        startLat: 45.4642,
        startLon: 9.1900,
        ...
        yearStart: 1597,
        yearEnd: 1597,
        titleEn: "Expulsion from Milan (1597)",
        titleHe: "גירוש ממילאנו (1597)",
        color: expulsion_color,
        description: "Jews were expelled from Milan, Italy"
    },
    {
        startLat: 45.0703,
        startLon: 7.6869,
        ...
        yearStart: 1720,
        yearEnd: 1720,
        titleEn: "Expulsion from Duchy of Savoy (1720)",
        titleHe: "גירוש מדוכסות סבויה (1720)",
        color: expulsion_color,
        description: "Jews were expelled from the Duchy of Savoy"
    },
    {
        startLat: 41.9028,
        startLon: 12.4964,
        ...
        yearStart: 1593,
        yearEnd: 1593,
        titleEn: "Expulsion from Papal States (1593)",
        titleHe: "גירוש ממדינת האפיפיור (1593)",
        color: expulsion_color,
        description: "Pope Clement VIII expelled Jews from most of the Papal States, allowing them to reside only in Rome and Ancona"
    },
    {
        startLat: 47.1625,
        startLon: 19.5033,
        ...
        yearStart: 1360,
        yearEnd: 1364,
        titleEn: "Expulsion from Hungary (1360-1364)",
        titleHe: "גירוש מהונגריה (1360-1364)",
        color: expulsion_color,
        description: "King Louis I expelled Jews from Hungary; they were allowed to return in 1364"
    },
    {
        startLat: 47.1625,
        startLon: 19.5033,
        ...
        yearStart: 1582,
        yearEnd: 1582,
        titleEn: "Expulsion from Hungary (1582)",
        titleHe: "גירוש מהונגריה (1582)",
        color: expulsion_color,
        description: "Jews were expelled from Hungary again under Emperor Rudolf II"
    },
    {
        startLat: 50.0755,
        startLon: 14.4378,
        ...
        yearStart: 1542,
        yearEnd: 1545,
        titleEn: "Expulsion from Bohemia (1542-1545)",
        titleHe: "גירוש מבוהמיה (1542-1545)",
        color: expulsion_color,
        description: "King Ferdinand I ordered the expulsion of Jews from Bohemia; they were allowed to return in 1545"
    },
    {
        startLat: 50.0755,
        startLon: 14.4378,
        ...
        yearStart: 1561,
        yearEnd: 1561,
        titleEn: "Expulsion from Bohemia (1561)",
        titleHe: "גירוש מבוהמיה (1561)",
        color: expulsion_color,
        description: "Jews were expelled from Bohemia again under Emperor Ferdinand I"
    },
    {
        startLat: 50.0755,
        startLon: 14.4378,
        ...
        yearStart: 1744,
        yearEnd: 1748,
        titleEn: "Expulsion from Bohemia (1744-1748)",
        titleHe: "גירוש מבוהמיה (1744-1748)",
        color: expulsion_color,
        description: "Empress Maria Theresa ordered the expulsion of Jews from Bohemia; the order was rescinded in 1748"
    },
    {
        startLat: 49.7437,
        startLon: 15.3386,
        ...
        yearStart: 1744,
        yearEnd: 1748,
        titleEn: "Expulsion from Moravia (1744-1748)",
        titleHe: "גירוש ממוראביה (1744-1748)",
        color: expulsion_color,
        description: "Empress Maria Theresa ordered the expulsion of Jews from Moravia; the order was rescinded in 1748"
    },
    {
        startLat: 49.8397,
        startLon: 24.0297,
        ...
        yearStart: 1494,
        yearEnd: 1494,
        titleEn: "Expulsion from Galicia (1494)",
        titleHe: "גירוש מגליציה (1494)",
        color: expulsion_color,
        description: "Jews were expelled from Galicia (now part of Poland and Ukraine)"
    },
    {
        startLat: 49.8397,
        startLon: 24.0297,
        ...
        yearStart: 1648,
        yearEnd: 1648,
        titleEn: "Khmelnytsky Uprising (1648)",
        titleHe: "מרד חמלניצקי (1648)",
        color: expulsion_color,
        description: "During the Khmelnytsky Uprising, Jews were massacred and expelled from parts of Galicia"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1453,
        yearEnd: 1453,
        titleEn: "Expulsion from Poland (1453)",
        titleHe: "גירוש מפולין (1453)",
        color: expulsion_color,
        description: "Jews were expelled from parts of Poland following accusations of ritual murder"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1495,
        yearEnd: 1501,
        titleEn: "Expulsion from Kraków (1495-1501)",
        titleHe: "גירוש מקרקוב (1495-1501)",
        color: expulsion_color,
        description: "King John I Albert expelled Jews from Kraków; they were allowed to return in 1501"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1555,
        yearEnd: 1555,
        titleEn: "Expulsion from Poland (1555)",
        titleHe: "גירוש מפולין (1555)",
        color: expulsion_color,
        description: "Jews were expelled from parts of Poland following accusations of desecrating the host"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1655,
        yearEnd: 1655,
        titleEn: "Swedish Invasion Expulsions (1655)",
        titleHe: "גירושים בפלישת שוודיה (1655)",
        color: expulsion_color,
        description: "During the Swedish invasion of Poland, Jews were expelled from various towns"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1768,
        yearEnd: 1768,
        titleEn: "Bar Confederation Expulsions (1768)",
        titleHe: "גירושים בברית בר (1768)",
        color: expulsion_color,
        description: "Following the Bar Confederation, Jews were expelled from parts of Poland"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1795,
        yearEnd: 1795,
        titleEn: "Third Partition Expulsions (1795)",
        titleHe: "גירושים בחלוקה השלישית (1795)",
        color: expulsion_color,
        description: "Following the Third Partition of Poland, Jews were expelled from areas annexed by Prussia"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1823,
        yearEnd: 1823,
        titleEn: "Village Expulsions (1823)",
        titleHe: "גירושים מכפרים (1823)",
        color: expulsion_color,
        description: "Jews were expelled from villages and rural areas in Congress Poland"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1846,
        yearEnd: 1846,
        titleEn: "Kraków Uprising Expulsions (1846)",
        titleHe: "גירושים במרד קרקוב (1846)",
        color: expulsion_color,
        description: "Following the Kraków Uprising, Jews were expelled from Kraków"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1881,
        yearEnd: 1881,
        titleEn: "Pogrom Expulsions (1881)",
        titleHe: "גירושים בפוגרומים (1881)",
        color: expulsion_color,
        description: "Following the assassination of Tsar Alexander II, pogroms led to the expulsion of Jews from various towns"
    },
    {
        startLat: 50.0647,
        startLon: 19.9450,
        ...
        yearStart: 1919,
        yearEnd: 1919,
        titleEn: "Polish-Soviet War Expulsions (1919)",
